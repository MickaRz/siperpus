...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_peminjaman dp ON p.id_pinjam=dp.id_pinjam
        INNER JOIN buku b ON b.id_buku=dp.id_buku where p.id_pinjam='$id_pinjam'";
		...
		<div class="col-md-7">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><?=date('d F Y', strtotime($detail['tgl_jatuhtempo']))?></td>
				</tr>
				<tr>
